        ...
        if target:
            ...
            if err:
                ...
                st.markdown(
                    ...
                    f'border-radius:0 8px 8px 0;padding:10px 14px;margin:4px 0 10px;">'
                    f'<div style="font-size:0.7rem;color:#FF6B35;font-family:monospace;'
                    f'margin-bottom:4px;">WHY {target} IS HERE</div>'
                    f'<div style="font-size:0.86rem;color:#DADADA;line-height:1.5;">{text}</div>'
                    f'<div style="font-size:0.66rem;color:#5E5E5E;margin-top:6px;">'
                    f'Generated by an LLM from the model\'s own numbers, so it can '
                    f'misread. The grid below is the source of truth.</div></div>',
